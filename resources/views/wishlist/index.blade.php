...
<div class="container mx-auto px-4 py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('home.index') }}" class="btn btn-outline-custom">
            ...
            @foreach($wishlists as $wishlist)
                <div class="col">
                    <div class="card h-100 border-0 shadow-sm hover-shadow">
                        ...
                        <div class="card-body">
                            <h5 class="card-title h6 mb-2">{{ $wishlist->produk->nama }}</h5>
                            <p class="card-text small text-muted mb-2">{{ Str::limit($wishlist->produk->deskripsi, 80) }}</p>
                            
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <div>
                                    <span class="h5 text-custom mb-0">Rp {{ number_format($wishlist->produk->harga_diskon, 0, ',', '.') }}</span>
                                    @if($wishlist->produk->diskon > 0)
                                        <br>
                            ...
                            <form onsubmit="return addToCart(event, this, {{ $wishlist->produk->id }}, {{ $wishlist->produk->harga_diskon }})" class="d-grid">
                                @csrf
