            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    <div class="timeline">
                        ...
                        <!-- Pembayaran -->
                        <div class="timeline-item">
                            <div class="timeline-dot {{ $order->payment_status === 'paid' ? 'bg-success' : 'bg-secondary' }}">
                                <i class="bi bi-check-lg text-white"></i>
                            </div>
                            <div class="timeline-content">
                        ...
                        <!-- Pesanan Diproses -->
                        <div class="timeline-item">
                            <div class="timeline-dot {{ $order->status === 'processing' || $order->status === 'delivered' || $order->status === 'completed' ? 'bg-success' : 'bg-secondary' }}">
                                <i class="bi bi-check-lg text-white"></i>
                            </div>
                            <div class="timeline-content">
                        ...
                        <!-- Pesanan Dikirim -->
                        <div class="timeline-item">
                            <div class="timeline-dot {{ $order->status === 'delivered' || $order->status === 'completed' ? 'bg-success' : 'bg-secondary' }}">
                                <i class="bi bi-check-lg text-white"></i>
                            </div>
                            <div class="timeline-content">
                        ...
                        <!-- Pesanan Selesai -->
                        <div class="timeline-item">
                            <div class="timeline-dot {{ $order->status === 'completed' ? 'bg-success' : 'bg-secondary' }}">
                                <i class="bi bi-check-lg text-white"></i>
                            </div>
                            <div class="timeline-content">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="mb-0">Status: <span class="badge bg-{{ $order->payment_status === 'paid' ? 'success' : 'warning' }}">
