                ...
                <div class="row align-items-center p-5">
                    <div class="col-lg-7">
                        ...
                        <p class="mb-4">Diskon hingga <span class="fw-bold">70%</span> untuk produk tertentu. Jangan
                            lewatkan!</p>
                        <a href="#" class="btn btn-outline-primary btn-light btn-hover-warning fw-bold">Belanja
                            Sekarang</a>
            ...
            <div class="swiper-slide">
                <div class="row align-items-center p-5">
                    <div class="col-lg-7">
                        ...
                        <a href="#"
                            class="btn btn-outline-primary btn-lg text-uppercase rounded-1 btn-hover-warning px-4 py-2 mt-3">Belanja
                            Sekarang</a>
                    </div>
                    <div class="col-lg-5 text-center">
            ...
            <div class="swiper-slide">
                <div class="row align-items-center p-5">
                    <div class="col-lg-7">
                        ...
                        <a href="#"
                            class="btn btn-outline-primary btn-lg text-uppercase rounded-1 btn-hover-warning">Lihat
                            Koleksi</a>
                    </div>
                    <div class="col-lg-5 text-center">
