                        ...
                        <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 px-3 d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <a href="{{ route('admin.produk.edit', $produk->id) }}" class="btn btn-info btn-sm me-2">
                                 <i class="material-symbols-rounded" style="font-size: 15px; vertical-align: middle;">edit</i> Edit
                                </a>
                                ...
                                <div class="card shadow-sm">
                                    <div class="card-body p-2">
                                        <img src="{{ $produk->gambar ? asset('storage/' . $produk->gambar) : asset('storage/user.svg') }}"
                                            class="img-fluid rounded" alt="product photo" style="width: 100%; height: 300px; object-fit: cover;">
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-4">
                                                <div class="info-group">
                                                    <label class="text-uppercase text-dark text-xs font-weight-bolder">Kategori</label>
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="info-group">
                                                    <label class="text-uppercase text-dark text-xs font-weight-bolder">Stok</label>
                                                    <p class="mb-0 text-lg">
                                                        <span class="badge bg-{{ $produk->stok <= 10 ? 'danger' : 'success' }}">
                                                            {{ $produk->stok }} unit
                                                        </span>
                                                    </p>
                                                </div>
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="info-group">
                                                    <label class="text-uppercase text-dark text-xs font-weight-bolder">Harga Normal</label>
                                                    <p class="mb-0 text-lg {{ $produk->diskon > 0 ? 'text-decoration-line-through text-muted' : '' }}">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="info-group">
                                                    <label class="text-uppercase text-dark text-xs font-weight-bolder">
                                                        Harga Promo
                                                        <span class="badge bg-danger ms-2">-{{ $produk->diskon }}%</span>
                                                    </label>
                                            ...
                                            <div class="col-12">
                                                <div class="info-group">
                                                    <label class="text-uppercase text-dark text-xs font-weight-bolder">Deskripsi Produk</label>
