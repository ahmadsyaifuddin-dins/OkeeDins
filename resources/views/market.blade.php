                        ...
                        @if (Auth::check())
                            <div class="text-end me-3 dropdown">
                                ...
                                <ul class="dropdown-menu shadow-sm border-0 rounded-3" style="min-width: 200px;">
                                    ...
                                    <li>
                                        <a class="dropdown-item d-flex align-items-center py-2" {{-- href="{{ route('wishlist.index') }}"> --}}
                                            <svg width="18" height="18" class="me-2" viewBox="0 0 24 24">
                                        ...
                                        <form action="{{ route('logout') }}" method="POST">
                                            ...
                                            <button type="submit"
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                    viewBox="0 0 24 24" class="me-2" fill="none"
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="card mb-3 p-3 rounded-4 shadow border-0">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="food_fusion/images/product-thumb-11.jpg"
                            ...
                            <div class="swiper-slide">
                                <div class="card mb-3 p-3 rounded-4 shadow border-0">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="food_fusion/images/product-thumb-12.jpg"
                                                class="img-fluid rounded" alt="Card title">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body py-0">
                            ...
                            <div class="swiper-slide">
                                <div class="card mb-3 p-3 rounded-4 shadow border-0">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="food_fusion/images/product-thumb-13.jpg"
                                                class="img-fluid rounded" alt="Card title">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body py-0">
                            ...
                            <div class="swiper-slide">
                                <div class="card mb-3 p-3 rounded-4 shadow border-0">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="food_fusion/images/product-thumb-14.jpg"
                                                class="img-fluid rounded" alt="Card title">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body py-0">
